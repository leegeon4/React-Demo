// gird(격자, 테이블)
// 행제목은 세션이름들
// 열제목은 선택한 날 해당 주의 날짜들

// 선택한 bookable 데이터를 격자구조로 출력할 수 있는 오브젝트 만들기
...
export function  getGrid(bookable, startDate){
    ...
    // 선택한 bookable의 sessions 숫자를 문자열 이름으로 저장한 배열생성
    // bookable.sessions 는 id: 3은 [0,2,4] 를 ["","",""]
...
// 자바스크립트 프로퍼티 get/set 할 때, 객체. 프로퍼티 또는 객체[프로퍼티이름]
